...
RepoHarbor is released under the [MIT License](https://github.com/azmykn/RepoHarbor/blob/main/LICENSE) for public use. Copyright, version, repository, and contact: [Copyright & contact](./copyright).
