...
- Recapture `docs/public/shots/` from the RepoHarbor UI (old branded
...
- Do not commit agent transcripts, editor local state (`.cursor/`, `.claude/`),
  API keys, or anything under `~/.config/repoharbor` / `~/.local/share/repoharbor`.
